...
class Segmentation(TaskConfig):
    def init(self, name: str, model_dir: str, conf: Dict[str, str], planner: Any, **kwargs):
        ...
        if strtobool(self.conf.get("use_pretrained_model", "false")):    # JH deactivted
        ...
        self.target_spacing = (1.3671875, 1.3671875, 10.0)      # JH: verify
        # Setting ROI size - This is for the image padding
        #self.roi_size = (96, 96, 96)
        self.roi_size = (256, 256, 128)  # JH: sliding window size for train and infer
    ...
    def infer(self) -> Union[InferTask, Dict[str, InferTask]]:
        task: InferTask = lib.infers.Segmentation(
            ...
            #config={"largest_cc": True},  # JH taken from old UNet
        )
        return task
